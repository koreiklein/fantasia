...
class ExactImportTests(ImportTest, CommonObjects):
  def setUp(self):
    ...
    self.well_defined_functor = enrichedEndo.WellDefined(self.a, self.b, self.equivalence)
    self.exists_well_defined_functor = enrichedEndo.WellDefined(self.c, self.d, self.equivalence).compose(
        endofunctor.Exists(self.c))
    self.well_defined_exists_functor = endofunctor.Exists(self.e).compose(
        enrichedEndo.WellDefined(self.c, self.d, self.equivalence))
